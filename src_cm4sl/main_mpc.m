function [u_mpc] = main_mpc(t, input, params, controller_on, points_x_r, points_x_l, points_y_r, points_y_l, obstacle_detected, ds_x, ds_y)
...
if t == 0
    ...
    for k = 1:N
        ...
        obj = obj + obs_on_1*Qo*radfl1(k)^2 + obs_on_1*Qo*radfr1(k)^2 + obs_on_2*Qo_big*radfl2(k)^2 + obs_on_2*Qo_big*radfr2(k)^2;
...
%   x(k+1)
    ...
    obj = obj + obs_on_1*Qo*radfl1(N+1)^2 + obs_on_1*Qo*radfr1(N+1)^2 + obs_on_2*Qo_big*radfl2(N+1)^2 + obs_on_2*Qo_big*radfr2(N+1)^2;
