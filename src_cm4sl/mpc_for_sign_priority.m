...
% params = [lf, lr, m, I, ha]
persistent opti r x0 u_prev v x u as k0L k1L k2L k0R k1R k2R sfr sfl srr srl radfl1 radfr1 radfl2 radfr2 dsx_1 dsx_2 dsy_1 dsy_2 radius_1 radius_2 sD obs_on_1 obs_on_2 caf car
...
if(controller_on ~= 1 || 0 == input(3)) % check v_min and start_time boundary
    ...
    if SignDetections(1) > 0 % caution sign
        opti.set_value(radius_1,1.5);
    ...
    if SignDetections(3) > 0 % children sign
        opti.set_value(radius_2,1);
